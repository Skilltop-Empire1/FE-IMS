...
const ViewSaleRecordModal = ({ showModal, setShowModal, record, handleUpdate }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-600 bg-opacity-50">
      <div className="bg-white rounded-lg shadow-lg p-6 w-11/12 md:w-1/3 h-4/5 overflow-y-auto">
        <h2 className="text-xl font-semibold mb-4">Sales Record Information</h2>
...
export default ViewSaleRecordModal;
