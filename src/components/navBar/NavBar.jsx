...
function NavBar({ dropdownRef }) {
  ...
  const { notifications, hasNewNotification, setHasNewNotification, alertMessage, isConnected } = useContext(NotificationContext);
      ...
      <ul className={style.rightNavs}>
        ...
        <li>
          <div className="relative mt-2">
            <button className="text-white relative" onClick={handleNotificationClick}>
