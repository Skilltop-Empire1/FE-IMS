...
const EditProductModal = ({ showUpdateModal, setShowUpdateModal, productToUpdate, confirmUpdateProduct }) => {
  ...
  const { data: stores = [], isLoading: isLoadingStores, isError: isErrorStores } = useGetStoresQuery();
             ...
             <div>
              ...
              <div>
                ...
                {isLoading ? (
                  ...
                  <p className="text-red-500">Error fetching categories. Please try again.</p>
                ) : (
                  <select
              ...
              <div>
                ...
                {isLoadingStores ? (
                  ...
                  <p className="text-red-500">Error fetching stores. Please try again.</p>
                ) : (
                  <select
